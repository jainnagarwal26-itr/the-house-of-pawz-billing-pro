...
export async function fetchCompanySettingsFromSupabase(): Promise<CompanySettings | null> {
  try {
    ...
    return {
      ...
      upiId: s.upi_id || '',
      logoPath: s.logo_url || 'https://dxvnemdmgdckdfzilnkr.supabase.co/storage/v1/object/public/company-assets/Logo.jpg',
      signaturePath: s.signature_url || 'https://dxvnemdmgdckdfzilnkr.supabase.co/storage/v1/object/public/signatures/Signature.jpg',
